<section class="company" id="company">
    <div class="company__inner inner">
        <h3 class="company-ttl about__sec-ttl">会社について</h3>
        <p class="company-lead">カシワバラグループは、塗装業から始まり、インフラメンテナンス・マンション大規模修繕を中心に拡大を続けてきました。<br>
            それらを主要事業として成長させる傍ら、M&Aや新規事業立案を行い、今では売上1040億円の企業グループになるまで成長しました。<br>
