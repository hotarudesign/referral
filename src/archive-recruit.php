    ...
    <div class="recruit">
        ...
        <div class="recruit__inner inner">
            <div class="recruit__container">
                <div class="recruit__txt">
                    <p class="recruit__txt-desc">
                ...
                <div class="recruit__occupation">
                    <h3 class="recruit__occupation-ttl">
                        募集職種一覧
                    </h3>
                    <ul class="recruit__occupation__list">
                        <?php
                        $args = array(
                            'post_type' => 'recruit',
                            'posts_per_page' => 4
                        ...
                        <?php if ($my_query->have_posts()) : while ($my_query->have_posts()) : $my_query->the_post(); ?>
                                <li class="recruit__occupation__item">
